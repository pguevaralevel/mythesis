...
\begin{center}
	...
	{\Large{\textbf{THESIS}}}\\[\baselineskip]
	submitted in fulfillment of the requirements for the degree of\\[\baselineskip]
	{\Large\textit{{\textbf{Doctor of Philosophy}}}}\\[\baselineskip]
	in Physical-Chemistry at\\[\baselineskip]
	UNIVERSIT\'E DE PAU ET DES PAYS DE L'ADOUR \\[\baselineskip]
	...
	Advisors: \textbf{Pr Didier B\'EGU\'E}\\[\baselineskip]
	defended on September XXth, 2016\\[\baselineskip]
	for the commission composed by\\[\baselineskip]~\\[\baselineskip] 
...
\include{intro/intro}
\include{Asp/chap1}
\include{ChapitreD/Chapitre_DFT}
