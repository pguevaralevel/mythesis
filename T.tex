...
\newcommand{\PRESn}{Prof BARAILLE Isabelle}
\newcommand{\PRESp}{Université de Pau et des Pays de l'Adour, France}
\newcommand{\PRESq}{}

\newcommand{\INVAn}{Prof B\'EGU\'E Didider }
\newcommand{\INVAp}{Université de Pau et des Pays de l'Adour, France}
\newcommand{\INVAq}{}
\newcommand{\RAPAn}{Dr HANOUNE Benjamin }
\newcommand{\RAPAp}{CNRS, Université de Lille 1, France}
\newcommand{\RAPAq}{Rapporteur}
\newcommand{\RAPBn}{Dr LEB\'EGUE Sebastien}
\newcommand{\RAPBp}{Université de Lorraine, France}
\newcommand{\RAPBq}{}

\newcommand{\EXAAn}{Dr MASCETTI Jo\"{e}lle}
\newcommand{\EXAAp}{Universit\'e de Bordeaux 1, France}
\newcommand{\EXAAq}{Rapporteur}

\newcommand{\EXABn}{Dr MICHAELIAN Kirk}
\newcommand{\EXABp}{Natural Resources Canada's. CanmetENERGY, Canada}
\newcommand{\EXABq}{}

\newcommand{\EXACn}{Prof SHAW Jhon}
\newcommand{\EXACp}{Université d'Alberta, Canada}
\newcommand{\EXACq}{}
...
\begin{center}
	...
	\vspace*{-5pt}
	{\Large\textbf{Vibrational spectra calculations as fingerprints for the elucidation of the composition and reactivity of complex chemical systems: application to asphaltene systems}}~\\[\baselineskip]
...
\renewcommand*\contentsname{Table des Matière} %troca o nome do sumario para o que quiser
...
\include{intro/intro}
\include{Asp/Chap1}
\include{vib/ChapvibEG}
\include{chap3/chap3EG}
\include{chap-P1/P1}
\include{chap-P2/P2}
\include{chap4/chap4-29sept2016v4}
\include{MD/MD}
\include{conclu/conclu}
\begin{appendices}
	\include{anex/anex3}
	\include{anex/etatS}
	\include{anex/P2-Mon}
