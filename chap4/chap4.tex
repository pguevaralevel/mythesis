		...
		\resizebox{17cm}{!}{
	       \begin{tabular}{c c c c c c c c c}
			\toprule
	     	...
	     	\end{tabular}}
	\end{center}
	\footnotemark{a Theoretical intensities obtained using perturbational-variational calculations, with truncated potential on the 20 first modes.}
	\footnotemark{b Theoretical intensities obtained for the distorted molecule, at the harmonic level.}
	\footnotemark{c The letter R indicates Raman-active modes.}
\end{table}
...
\begin{table}[htb]
	...
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\footnotemark{CP refers to the keyword “counterpoise” used in Gaussian to take BSSE-correction in account in the calculations.}
\end{table}
