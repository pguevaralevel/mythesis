...
\textit{}
 	...
 	\begin{figure}[H]
 		...
 		\end{center}
 		\caption{The \textit{qc} and \textit{ab} planes of anthracene crystal}  \label{fig-Anthrasol}
 	\end{figure}
 	...
 	\begin{figure}[H]
 		...
 		\end{center}
 		\caption{The \textit{ac}, \textit{ab} planes of pentacene polymorph C at the top and \textit{bc} plane of pentacene polymorph H at the bottom}  \label{fig-Pentasol}
 	\end{figure}
 	...
 	\end{table}
 		...
 		\end{table}
 					...
 					\begin{figure}[H]
 						\begin{center}
 							\subfigure{\includegraphics[scale=0.042]{image/Perylene-b}}
 							\subfigure{\includegraphics[scale=0.042]{image/Perylene-a}}
 						\end{center}
 	...
 	\begin{figure}[H]
 		\begin{center}
 			\subfigure{\includegraphics[scale=0.042]{image/Carbazole-a}}
 			\subfigure{\includegraphics[scale=0.042]{image/Carbazole-c}}
 		\end{center}
 	...
 	\begin{figure}[H]
 		\begin{center}
 			\subfigure{\includegraphics[scale=0.042]{image/Dibenzofuran-b}}
 			\subfigure{\includegraphics[scale=0.042]{image/Dibenzofuran-c}}
 		\end{center}
 	...
 	\begin{figure}[H]
 		\begin{center}
 			\subfigure{\includegraphics[scale=0.042]{image/Dibenzothiophene-b}}
 			\subfigure{\includegraphics[scale=0.042]{image/Dibenzothiophene-z}}
 		\end{center}
